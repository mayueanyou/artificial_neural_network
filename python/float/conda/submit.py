...
if __name__ == '__main__':
    ...
    py_file = '/home/yma183/lab/artificial_neural_network/python/float/network.py '
    #base_path = '/condor/original/RN_original/'
    condor_submit('/home/yma183/lab/artificial_neural_network/python/float/conda/test5' , py_file)
